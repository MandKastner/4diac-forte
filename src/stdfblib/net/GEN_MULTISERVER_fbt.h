 ...
 *******************************************************************************/
#ifndef _GEN_MULTI_SERVER_H_
#define _GEN_MULTI_SERVER_H_
...
class GEN_MULTISERVER: public forte::com_infra::CCommFB {
    DECLARE_GENERIC_FIRMWARE_FB(GEN_MULTISERVER)
  public:
    GEN_MULTISERVER(const CStringDictionary::TStringId paInstanceNameId, forte::core::CFBContainer &paContainer);
    ~GEN_MULTISERVER() override = default;
